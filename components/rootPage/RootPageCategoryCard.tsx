...
const RootPageCategoryCard = ({ cardData }: { cardData: RootPageCard }) => {
    ...
    return (
        <Link
            ...
            className='w-40 md:w-[50%] py-3 rounded-2xl text-center items-center flex flex-col gap-2 bg-background-secondary w-'>
            <div className='h-24 w-32 md:h-fit md:w-[80%] flex items-center justify-center overflow-hidden'>
